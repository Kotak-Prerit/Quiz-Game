...
function showQuetions(index){
    ...
    let ans_list = '<div class="ans">' + questions[index].options[0] +'<p></p></div>' +
                    '<div class="ans">' + questions[index].options[1] +'<p></p></div>' +
                    '<div class="ans">' + questions[index].options[2] +'<p></p></div>' +
                    '<div class="ans">' + questions[index].options[3] +'<p></p></div>';
...
function showResultbox(){
    ...
    if(score < 2){
        let comment = '<span>Try again later. You got only <p>' + score + '</p> out of <p>' + questions.length + '</p> Questions Correct</span>';
        correctAns.innerHTML = comment;
    }
    if(score > 3){
        let comment = '<span>Congratulations 🥳 You Scored <p>' + score + '</p> out of <p>' + questions.length + '</p>.</span>';
        correctAns.innerHTML = comment;
    }
    if(score == 3){
        let comment = '<span>Nice 😎. You scored <p>' + score + '</p> out of <p>' + questions.length + '</p> Questions Correctly</span>';
        correctAns.innerHTML = comment;
    }
}
